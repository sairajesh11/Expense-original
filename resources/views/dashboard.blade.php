...
<nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
  <a style="font-family: 'Arial'; font-size: 20px" class="navbar-brand" href="/dashboard">Home</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <a style="font-family: 'Arial'; font-size: 20px; position : absolute;  right:0;" class="navbar-brand" href="{{ route('signout') }}">Logout</a>
    ...
    <div class="content">
        ...
        <table class="table table-sm table-dark" style="width: 70px">
            <thead>
              <tr>
                <th scope="col">No</th>
