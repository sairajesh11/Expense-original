...
<nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
  <a style="font-family: 'Arial'; font-size: 20px; position : absolute;  right: 1100px" class="navbar-brand" href="/">Home</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a style="font-family: 'Arial'; font-size: 16px; position : absolute;  right: 900px;" class="navbar-brand" href="/form">Request form</a>
      </li>
      <li class="nav-item">
        <a style="font-family: 'Arial'; font-size: 16px; position : absolute;  right: 1000px;" class="navbar-brand" href="/contact">Receipt form</a>
      </li>
      <li class="nav-item">
